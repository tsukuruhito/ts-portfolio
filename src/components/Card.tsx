          ...
          >
            ...
            >
              ...
              <div className="absolute bottom-2 right-2">
                ...
                <span className="border-2 border-t-0 ml-2 border-l-0 w-2 h-2 inline-block -rotate-45"></span>
              </div>
              <div
              ...
              >
                ...
                {i.auth && (
                  <p className="mt-2 text-sm md:text-base">{i.auth}</p>
                )}
                <div className="mt-2">
                  {i.stack && (
                    <>
                      ...
                      <p className=" text-sm md:text-base">{i.stack}</p>
                    </>
                  )}
                </div>
              </div>
