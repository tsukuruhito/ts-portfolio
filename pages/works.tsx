    ...
    <Layout title="works" isHeader={true} isFooter={true}>
      ...
      ">
        <div className="mb-8 font-mono">
          ...
          <p className="text-lg leading-6">This is works and practice products.</p>
          <p className="text-lg leading-6">Mainly use React , Next.js and TypeScript.</p> 
        </div>
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-3 ">
            {tech.map((tech) => {
              return (
                <div key={tech.id} className="card glass max-w-md md:w-full mx-auto w-full">
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-3 ">
            {design.map((design) => {
              return (
                <div key={design.id} className="card glass max-w-md md:w-full mx-auto w-full">
                  <div className="relative w-full h-64 md:h-40">
                    <Image
                      src={design.image}
                      alt={design.title}
